#!/bin/bash
#SBATCH --job-name=llava_leo_clip_s1_pretrain_1GPU
...
#SBATCH --qos=normal
#SBATCH --output=llava_leo_clip_s1_pretrain_1GPU.out
#SBATCH --error=llava_leo_clip_s1_pretrain_1GPU.err
...
# VISION_TOWER_PROCESSOR_CLEAN="openai/clip-vit-large-patch14-336"
############### Pretrain ################
